...
- Use [`weather/tests/capture_weather_3d.tscn`](weather/tests/capture_weather_3d.tscn) for focused steady-rain presentation validation, and [`scenes/tests/test_game_world_3d.tscn`](scenes/tests/test_game_world_3d.tscn) for weather-manager, rig, and wind-aware-water integration coverage.
