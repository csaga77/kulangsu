...
`piano_game.gd` and `piano_game.tscn` define the module interface, but there is currently no trigger in `scenes/game_world_3d.gd`, `main.gd`, or any production world subject that instantiates or enters this module during normal gameplay.
