...
- `test_street_terrain_integration.gd` covers automatic Street3D discovery, base-grid terrain sampling, corridor bed shaping, unaffected exterior terrain, manual profile-height preservation, coalesced terrain regeneration after an authored street-width change, and preservation of an individual generated-street width override during its terrain refresh.
