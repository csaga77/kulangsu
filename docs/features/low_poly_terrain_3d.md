...
- Heightmap elevation sampling reads through the same cached `_ImagePixelReader` RGBA8 buffer as the mask path instead of calling `Image.get_pixel` per cell.
