...
- [`../../terrain/low_poly_terrain_3d.gd`](../../terrain/low_poly_terrain_3d.gd) owns the parallel low-poly 3D terrain prototype. It reuses this terrain profile and mask semantics, can optionally add grayscale heightmap elevation as a smooth low-poly land surface, and now renders faceted vertex-colored 3D water with a semi-transparent surface layer plus separate shoreline highlight bands, but it is not part of the runtime 2D overworld contract yet.
