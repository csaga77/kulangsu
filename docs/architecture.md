...
- modular storyline route/event definitions in `game/storylines/`, with `story_route_graph.gd` projecting them into route progress, lead selection, canonical story-event availability checks, and endgame-trigger logic
