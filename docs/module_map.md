...
- [`../addons/low_poly_building_editor/`](../addons/low_poly_building_editor) - native editor dock and 3D viewport tool for low-poly building authoring. It registers `BuildingEditor3D`, `ProceduralWall3D`, and `BuildingOpening3D`; supports grid-snapped eight-way wall drawing, collinear wall merging, automatic absorption of intersecting walls into one multi-segment `ProceduralWall3D` with combined clipped geometry, translucent prop/window/door previews, generated collision for wall raycasts, and split wall meshes around window/door-opening child nodes. The focused smoke scene is [`../scenes/tests/test_low_poly_building_editor_3d.tscn`](../scenes/tests/test_low_poly_building_editor_3d.tscn), and the feature spec is [`features/low_poly_building_editor.md`](features/low_poly_building_editor.md).
