...
- [`../addons/low_poly_building_editor/`](../addons/low_poly_building_editor) - native editor dock and 3D viewport tool for low-poly building authoring, plus the versioned `building_spec.gd` / `building_spec_compiler.gd` / `generate_building.gd` JSON-to-scene path for deterministic agent and batch generation. See the plugin's own docs for the full description: [`../addons/low_poly_building_editor/README.md`](../addons/low_poly_building_editor/README.md) (overview), [`../addons/low_poly_building_editor/docs/feature.md`](../addons/low_poly_building_editor/docs/feature.md) (feature spec), and [`../addons/low_poly_building_editor/docs/contract.md`](../addons/low_poly_building_editor/docs/contract.md) (contract).
