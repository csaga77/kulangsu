...
- [`../scenes/game_world_3d.tscn`](../scenes/game_world_3d.tscn) / [`../scenes/game_world_3d.gd`](../scenes/game_world_3d.gd) - production low-poly 3D overworld composition root: builds `LowPolyTerrain3D`, `HumanBody3D`, an orthographic camera, five landmark anchors (three stylized building instances plus tunnel markers), maps the shared player profile to male/female/boy GLBs, spawns the shared wandering resident roster, composes focused surface-follow and story-interaction components, owns shared BGM/landmark-cue audio and generated landmark collision, and syncs location/landmark/resume state into `AppState`
