...
- [`../scenes/tests/test_street_mask_generation.tscn`](../scenes/tests/test_street_mask_generation.tscn) - focused STREET-mask regression covering centerline extraction, bent multipoint and sibling-junction generated street geometry, terrain corridor shaping, and replacement rather than accumulation on rebuild
