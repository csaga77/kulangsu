...
- [`../game/tests/persistence/fixtures/`](../game/tests/persistence/fixtures/) - reversible fixed-save launch scenes for Milestone A's open-Winter and legacy post-closer Title -> Continue checks, plus the previous-save restore scene
