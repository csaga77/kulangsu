...
- [`../scenes/tests/test_low_poly_world_3d.tscn`](../scenes/tests/test_low_poly_world_3d.tscn) - combined low-poly 3D validation slice covering terrain generation, land collision, coordinate round-tripping, `HumanBody3D`, `PlayerController3D`, and camera framing
