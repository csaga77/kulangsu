...
- `game/storylines/` owns canonical route and route-event authoring, while `game/story_route_graph.gd` owns projection, lead selection, endgame-trigger evaluation, ending-behavior classification, and baseline ending-tone tag generation
