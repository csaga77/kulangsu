...
- generated `StreetJunction3D` render geometry retains closed thickness, but collision is a two-sided sheet over only upward walkable centre geometry so grounded characters can recover across coplanar seams and incident road boundaries cannot become invisible barriers
