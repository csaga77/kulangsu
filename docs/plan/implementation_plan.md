...
- `ProceduralLowPolyCharacterRig` generates a `Skeleton3D`, flat-shaded vertex-color body surface, and head/hand `BoneAttachment3D` nodes at runtime, without external baked mesh, texture, or animation assets
