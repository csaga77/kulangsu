...
@export_range(0.0, 2.0, 0.01) var shadow_strength: float = 0.92:
	set(value):
		shadow_strength = clampf(value, 0.0, 2.0)
		_update_material()
...
func _update_material() -> void:
	...
	m_shader_material.set_shader_parameter("detail_scale", detail_scale)
...
func _advance_drift(delta: float) -> void:
	...
	var pixels_per_second := drift_speed * wind_strength
