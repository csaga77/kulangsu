...
@onready var m_bi_shan_tunnel_entry_south: Node2D = $terrain/bi_shan_tunnel/exterior/bi_shan_tunnel_entries/entry_south
@onready var m_bi_shan_tunnel_entry_north: Node2D = $terrain/bi_shan_tunnel/exterior/bi_shan_tunnel_entries/entry_north
@onready var m_long_shan_tunnel_entry_south: Node2D = $terrain/long_shan_tunnel/exterior/long_shan_tunnel_entries/entry_south
@onready var m_long_shan_tunnel_entry_north: Node2D = $terrain/long_shan_tunnel/exterior/long_shan_tunnel_entries/entry_north
